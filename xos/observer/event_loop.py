...
class XOSObserver:
	...
	def run(self):
		print "1 Running XOSObserver....."
		if not self.driver.enabled:
			return
		print "2 Running XOSObserver....."

		print "XXX: %s | %s"%(self.driver_kind, self.driver.has_openstack)
		if (self.driver_kind=="openstack") and (not self.driver.has_openstack):
			return
		print "3 Running XOSObserver....."

		while True:
			print "4 Running XOSObserver....."
			try:
