...
class SyncSlivers(OpenStackSyncStep):
    ...
    def sync_record(self, sliver):
        ...
        sliver_id = 'sliver-0'#res[1]['info']['OS-EXT-SRV-ATTR:instance_name'] # 0 is for the key
        sliver_uuid = '58558e08-c2a4-11e4-8dfc-aa07a5b093db'#res[1]['id'] # 0 is for the key

        try:
            hostname = 'localhost'#res[1]['info']['OS-EXT-SRV-ATTR:hypervisor_hostname']
