    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view_url', models.CharField(max_length=1024, null=True, blank=True)),
                ('icon_url', models.CharField(max_length=1024, null=True, blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='deployments',
            field=models.ManyToManyField(help_text=b'Deployments that should be included in this view', related_name=b'dashboardviews', null=True, to='core.Deployment', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='deployment',
            field=models.ForeignKey(related_name=b'controllerdeployments', to='core.Deployment'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='charge',
